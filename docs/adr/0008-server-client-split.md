...
> Node discovery、Client authority access 与 DNS/static-list 决策已由 [ADR-0010](0010-node-directory-coordination-store.md) supersede；Server/Client 拆分、Gateway 中继与 transport seam 仍然有效。
