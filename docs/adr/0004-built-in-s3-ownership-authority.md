...
> Public backend configuration and the `OwnershipBackend` seam were superseded by [ADR-0010](0010-node-directory-coordination-store.md); the S3 conditional-write correctness decisions remain valid.
