...
> [ADR-0013](0013-client-direct-owner-placement.md) supersede 本 ADR 的 Node-to-Node 业务传输拓扑与每 endpoint 单 stream 决策。双向 Envelope transport seam、Session ID 多路复用和复用入站连接回传 Event 的决策仍然有效。
